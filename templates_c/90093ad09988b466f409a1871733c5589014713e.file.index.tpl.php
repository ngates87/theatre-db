<?php /* Smarty version Smarty-3.1.12, created on 2014-02-18 22:08:37
         compiled from "templates/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:133320790553042e45555f24-23802149%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '133320790553042e45555f24-23802149',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53042e457a7cc7_46136687',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53042e457a7cc7_46136687')) {function content_53042e457a7cc7_46136687($_smarty_tpl) {?><?php if (!is_callable('smarty_function_GetCurrentSeason')) include '/home/masc/www/Includes/3rdPartyLibs/smarty/plugins/function.GetCurrentSeason.php';
...
<head>
    ...
    <script src="/public/javascript/pages/index.js"></script>
...
?>
            <li>
                <a href='<?php echo $_smarty_tpl->tpl_vars['sliderItem']->value["hyperlink"];?>
' target="_blank">
                    <img src='Includes/Objects/ImageHandler.php?ImageID=<?php echo $_smarty_tpl->tpl_vars['sliderItem']->value["imageID"];?>
' alt="alt text" />
                </a>
            </li>
        <?php } ?>
...
<!-- Headline -->
<div class="headline">
    Come join us for some play!
</div>
<!-- ENDS Headline -->

<section id="about" style="width:99%; padding:5px;">
    <h1 class="home-block-heading" >About Us</h1>
    <p>Marshall Area Stage Co. is a community theatre organization formed in
        ...
        in our community. We are proud to enhance the cultural environment this
        area offers.</p>
    <p><strong>OUR MISSION</strong> - To encourage the growth of the performing
        arts in Marshall &amp; surrounding communities.</p>
    <p><strong>OUR GOAL</strong> - To enrich, entertain and educate Southwest
        Minnesota!</p>
</section>

<!-- home-gallery -->
<h1 class="home-block-heading">Sponsors</h1>
...
?>
        <li><a href='http://<?php echo $_smarty_tpl->tpl_vars['sponsor']->value->Website;?>
' class="thumb" target="_blank">
                <img src='Includes/Objects/ImageHandler.php?ImageID=<?php echo $_smarty_tpl->tpl_vars['sponsor']->value->Image_ID;?>
' alt="Alt text" /></a>
        </li>
    <?php } ?>
