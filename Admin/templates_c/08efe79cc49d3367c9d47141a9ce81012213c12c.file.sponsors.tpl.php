<?php /* Smarty version Smarty-3.1.12, created on 2014-02-19 08:44:22
         compiled from "templates/sponsors.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12753691745304c346365e60-29911442%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '08efe79cc49d3367c9d47141a9ce81012213c12c' => 
    array (
      0 => 'templates/sponsors.tpl',
      1 => 1390785863,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '12753691745304c346365e60-29911442',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5304c346596353_86753644',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5304c346596353_86753644')) {function content_5304c346596353_86753644($_smarty_tpl) {?><?php if (!is_callable('smarty_function_GetCurrentSeason')) include '/home/masc/www/Includes/3rdPartyLibs/smarty/plugins/function.GetCurrentSeason.php';
...
<script src="http://malsup.github.com/jquery.form.js"></script> 
<script src="/public/javascript/jquery.validate.js"></script>
<script type="text/javascript" src="/public/javascript/admin/sponsors.js"></script>
...
<body lang="en">
 ...
 Season</span></a>
	...
	<div id="masthead">
        <span class="head">Sponsors</span>
		<button id="btnAddSponsor" class="ui-form-submit">Create</button>
...
<div id="dialog" >
    ...
    <form id="frmSponsors" action="Ajax/Sponsors.php" enctype="multipart/form-data" method="post">
        <input type="hidden" id="inSponsorID" name="id" />
            <img id="preview" alt='currently uploaded image'/>
            <div>
                <label for="inActive"><strong>Active</strong></label>
                <input id="inActive" name="active" type="checkbox" />
            </div>
            <p>
                <span class='required' title='Required field.'>*</span>
                <label for="inSponsorName"><strong>Sponsor</strong></label>
                <br/>
                <input id="inSponsorName" name="name" type="text" required="required" class="input-long required"/>
            </p>
            <p>
                <label for="website"><strong>Website</strong></label><br/>
                <em><strong>http://</strong></em><input id="inWebsite" name="website" type="url" class="input-url"/>
            </p>
            <p>
                <span class='required' title='Required field.'>*</span>
                <label for="inLogo">
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th>Website</th>
                <th>Active</th>
                <th style="width:16px;"><!--Delete--></th>
            </tr>
        </thead>
        <tbody id="tblSponsors">
            <?php  $_smarty_tpl->tpl_vars['sponsor'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['sponsor']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['sponsors']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['sponsor']->key => $_smarty_tpl->tpl_vars['sponsor']->value){
$_smarty_tpl->tpl_vars['sponsor']->_loop = true;
?>
                <tr>
                    <td class="name">
                        <a class="readSponsor" data-id="<?php echo $_smarty_tpl->tpl_vars['sponsor']->value["id"];?>
" href='#'><?php echo $_smarty_tpl->tpl_vars['sponsor']->value["name"];?>
</a>
                    </td>
                    <td class="website" ><?php echo $_smarty_tpl->tpl_vars['sponsor']->value["website"];?>
</td>
                    <td class="active"><?php echo $_smarty_tpl->tpl_vars['sponsor']->value["active"];?>
</td>
                    <td>
                        <a class="delete" title='Delete Sponsor' href='#' data-id="<?php echo $_smarty_tpl->tpl_vars['sponsor']->value["id"];?>
">
