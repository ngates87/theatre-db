...
class GoogleMapAPI {
     ...
     * if enabled, be sure to include_once on your webpage:
    ...
    /**
     * determines if to/from directions are include_onced inside info window
     * 
     * @var bool
     * @deprecated
     */
    ...
    var $driving_dir_text = array(
            'dir_to' => 'Start address: (include_once addr, city st/region)',
            'to_button_value' => 'Get Directions',
            'to_button_type' => 'submit',
            'dir_from' => 'End address: (include_once addr, city st/region)',
    ...
    /**
     * Class variable that will store flag to minify js - this can be overwritten after object is instantiated.  include_once JSMin.php if 
     ...
     *
     * @param string $type New V3 Map Types, only include_once ending word (HYBRID,SATELLITE,TERRAIN,ROADMAP)
     */
