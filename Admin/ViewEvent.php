<?php
 //echo file_exists($_SERVER["DOCUMENT_ROOT"] . "/templates/viewevent.tpl");
...
/* @var $oEvent Event */
$oEvent = $daoEvents->GetEventByID($iEventID);
...
$smarty->display($_SERVER["DOCUMENT_ROOT"] . "/templates/viewevent.html");
?>
