<?php /* Smarty version Smarty-3.1.12, created on 2014-02-26 21:59:33
         compiled from "templates/venues.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1425596496530eb825beae32-21233892%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '50957c571ade812773464b21c8d254ecd39fd608' => 
    array (
      0 => 'templates/venues.tpl',
      1 => 1390785864,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1425596496530eb825beae32-21233892',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_530eb825e4b286_84257382',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_530eb825e4b286_84257382')) {function content_530eb825e4b286_84257382($_smarty_tpl) {?><?php if (!is_callable('smarty_function_GetCurrentSeason')) include '/home/masc/www/Includes/3rdPartyLibs/smarty/plugins/function.GetCurrentSeason.php';
...
<body lang="en">
 ...
 Season</span></a>
    ...
    <div id = "masthead">
        <span class="head"><?php echo $_smarty_tpl->tpl_vars['actionText']->value;?>
</span>
        <button id="btnAddVenue" type="submit" class="ui-form-submit"><?php echo $_smarty_tpl->tpl_vars['actionText']->value;?>
</button>
	</div>
...
<form id="frmAddVenue" enctype="multipart/form-data" method="post">
    <div class="ui-form-content">
        <p class="input-section">
            ...
            <br/>
            <input id="inVenueTitle" class="input-long" name="inVenueTitle" type="text" required="required" value="<?php echo $_smarty_tpl->tpl_vars['venueTitle']->value;?>
"/>
        </p>
        ...
        <p class="input-section">
            ...
            <br/>
            <input id="inVenueCity" name="inVenueCity" value="<?php echo $_smarty_tpl->tpl_vars['city']->value;?>
" />
        </p>
        <p class="input-section">
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("templates/StateSelect.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '1425596496530eb825beae32-21233892');
content_530eb825dedb61_49550694($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "templates/StateSelect.tpl" */?>
        ...
        <p  class="input-section">
            ...
            <br/>
            <input id="inVenueAddress" name="inVenueAddress" type="text" value="<?php echo $_smarty_tpl->tpl_vars['address']->value;?>
"/>
        </p>
        ...
        <p  class="input-section">
            ...
            <br/>
            <input id="inVenueZip" name="inVenueZip" type="text" value="<?php echo $_smarty_tpl->tpl_vars['zipCode']->value;?>
"/>
        </p>
        ...
        <p  class="input-section">
            ...
            <br/>
            <input id="inVenueCapacity" name="inVenueCapacity" type="number" value="<?php echo $_smarty_tpl->tpl_vars['capcity']->value;?>
"/>
        </p>
        <p>
...
?>
                    <tr>
                        <td>
                            <a href='Venues.php?VenueID=<?php echo $_smarty_tpl->tpl_vars['venue']->value["id"];?>
'><?php echo $_smarty_tpl->tpl_vars['venue']->value["name"];?>
</a>
                        </td>
                        <td>
                            <?php echo $_smarty_tpl->tpl_vars['venue']->value["capcity"];?>

                        </td>
                        <td>
                            <?php echo $_smarty_tpl->tpl_vars['venue']->value["address"];?>
,<?php echo $_smarty_tpl->tpl_vars['venue']->value["city"];?>
,<?php echo $_smarty_tpl->tpl_vars['venue']->value["state"];?>
,<?php echo $_smarty_tpl->tpl_vars['venue']->value["zip"];?>

                        </td>
                        <td>
                            <a title='Delete Event' href='#' onclick='RemoveVenue("<?php echo $_smarty_tpl->tpl_vars['venue']->value["id"];?>
",this);'>
...
<?php }} ?><?php /* Smarty version Smarty-3.1.12, created on 2014-02-26 21:59:33
         compiled from "templates/StateSelect.tpl" */ ?>
<?php if ($_valid && !is_callable('content_530eb825dedb61_49550694')) {function content_530eb825dedb61_49550694($_smarty_tpl) {?><option value="AL">Alabama</option>
