...
class ManageEventsView {
    eventListing = ko.observableArray<TCMS.EventItem>([]);

    dialogEvent = ko.observable<TCMS.NewEventViewModel>(new TCMS.NewEventViewModel());

    private ajaxUrl = "Ajax/Events.php";
    ...
    constructor() {
        $(() => {
            ...
            this.dialogEvent().eventNotes.subscribe((newValue) => {
